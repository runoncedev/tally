    ...
    >
        ...
        return (
          <>
            ...
            >
              ...
              />
              <path
                d={`M 0,100 L ${w + 0.7},100 C ${w + 1.5},125 ${w - 0.5},175 ${w + 0.7},200 L 0,200 Z`}
                fill={fill1}
              />
            </svg>
            ...
            <svg
              ...
              style={{
                height: "200%",
                opacity,
                animation: "wave-slide 4s linear -2s infinite",
              }}
            >
              <path
                d={`M 0,0 L ${w},0 C ${w + 2},25 ${w - 2},75 ${w},100 L 0,100 Z`}
                fill={fill2}
              />
              <path
                d={`M 0,100 L ${w},100 C ${w + 2},125 ${w - 2},175 ${w},200 L 0,200 Z`}
                fill={fill2}
              />
            </svg>
      ...
      <div className="flex items-center justify-between sm:hidden">
        <div className="flex items-center gap-2">
          <span
            className={`font-medium ${isPast ? "text-zinc-400 group-hover:text-zinc-900 dark:text-zinc-500 group-hover:dark:text-zinc-50" : ""}`}
          >
