    ...
    <div
      className={
        nested
          ...
          : `group relative -mt-px border border-zinc-300 dark:border-zinc-700 ${open && !animating ? "overflow-visible" : "overflow-clip focus-within:z-10 hover:z-10"} ${isFirst ? "mt-0 rounded-t-xl" : ""} ${isLast ? "rounded-b-xl" : ""}`
      }
    >
      {readOnly ? (
