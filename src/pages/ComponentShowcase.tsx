  ...
  return (
    <div>
      ...
      >
        ...
        {open ? "Hide" : "Show"} props ({rows.length})
      </button>
      {open && (
    ...
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <Section title="Button">
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          Three variants — <code className="text-xs">outlined</code>, <code className="text-xs">filled</code>, <code className="text-xs">ghost</code> — each with a <code className="text-xs">default</code> and <code className="text-xs">danger</code> color. Use <code className="text-xs">shape="square"</code> for icon-only buttons to get symmetric padding and a square aspect ratio.
        </p>
        <PropTable rows={[
          ...
          { prop: "shape", type: '"default" | "square"', default: '"default"', description: 'Square applies symmetric padding and aspect-square — use for icon-only buttons.' },
        ...
        <div className="space-y-6 rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-900">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-1">
              <Button variant="ghost" shape="square" title="Previous">
              ...
              <Button variant="ghost" shape="square" title="Next">
              ...
              <Button variant="ghost" shape="square" title="Calendar">
              ...
              <Button variant="ghost" shape="square" title="Inbox">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/></svg>
              </Button>
              <Button variant="ghost" shape="square" title="Sync">
              ...
              <Button variant="ghost" shape="square" title="Settings">
