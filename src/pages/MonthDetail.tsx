    ...
    <div>
      ...
      >
        ...
        <div className="lg:sticky lg:top-20">
          ...
          <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-center lg:flex-col lg:items-stretch">
            ...
            <div className="flex gap-2 lg:w-full">
              <Button variant="outlined" onClick={() => addRow("income")} className="flex-1 justify-center py-2 sm:flex-none sm:px-4 lg:flex-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-green-500 dark:text-green-400">
                  <line x1="12" y1="19" x2="12" y2="5" />
                  <polyline points="5 12 12 19 19 12" />
                </svg>
                Add income
              </Button>
              <Button variant="outlined" onClick={() => addRow("expense")} className="flex-1 justify-center py-2 sm:flex-none sm:px-4 lg:flex-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-red-500 dark:text-red-400">
            ...
            {(recurringPrefills.length > 0 || (import.meta.env.DEV && transactions.length > 0)) && (
              <div className="flex flex-col gap-2 sm:flex-1 sm:flex-row lg:flex-col">
                {recurringPrefills.length > 0 && (
                  ...
                  >
                    <Select.Trigger className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-300 px-3 py-2 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-50 hover:text-zinc-800 sm:w-auto sm:px-4 lg:w-full dark:border-zinc-700 dark:text-zinc-400 dark:hover:bg-zinc-800/50 dark:hover:text-zinc-200">
                ...
                {import.meta.env.DEV && transactions.length > 0 && (
                  <Button
                    ...
                    className="w-full justify-center py-2 sm:ml-auto sm:w-auto sm:px-4 lg:ml-0 lg:w-full"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex flex-col">
          ...
          {!isLoading && newRows.length === 0 && transactions.length === 0 && <EmptyState className="hidden lg:flex" />}
          {rows.map((row, i) =>
            row.kind === "tx" ? (
              <TransactionRow
                key={row.public_id}
